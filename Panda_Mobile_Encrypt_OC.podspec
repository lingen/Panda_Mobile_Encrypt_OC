Pod::Spec.new do |spec|
  ...
  spec.homepage = "https://github.com/lingen/Panda_Mobile_Encrypt_OC"
  ...
  spec.source = { git: "https://github.com/lingen/Panda_Mobile_Encrypt_OC", tag: "v#{spec.version}", submodules: true }
